...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 141943040 # This is the maximum known partition size, but it can be higher, so we just omit it
...
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := $(DEVICE_PATH)/key/rsa4096_system.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION := 1
BOARD_AVB_VBMETA_VENDOR := vendor
BOARD_AVB_VBMETA_VENDOR_KEY_PATH := $(DEVICE_PATH)/key/rsa4096_vendor.pem
BOARD_AVB_VBMETA_VENDOR_ALGORITHM := SHA256_RSA4096
BOARD_AVB_VBMETA_VENDOR_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_VBMETA_VENDOR_ROLLBACK_INDEX_LOCATION := 2
BOARD_AVB_RECOVERY_KEY_PATH := $(DEVICE_PATH)/key/rsa4096_recovery.pem
